...
public:
	std::vector<unsigned char> key; //Encryption key
	...
	void OpenStorage(string filename, std::vector<unsigned char> key, User currentUser);

	void AppendMessage(Channel c, iMessage msg, User currentUser);
